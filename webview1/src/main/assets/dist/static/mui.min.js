...
(function () {
    ...
    script.src = "http://sdk.talkingdata.com/app/h5/v1?appid=CD58ECF049D64779917F5E9E6DFD1C16&vn=荟医医生&vc=v2.0.1";
...
(function ($, window) {
    function detect(ua) {
        ...
        var funcs = [
            ...
            function () { //游览器
                this.os.browser = true;
                this.os.version = "chrome";
                window.plus = {
                    os: {
                        name: "iOS"
                    },
                    navigator: {
                        isImmersedStatusba: function () {
                            return true;
                        }
                    },
                    nativeUI: {
                    ...
                    storage: {
                        setItem: function (key, value, duration) {
                            var data = {
                                value: value,
                                expiryTime: !duration || isNaN(duration) ? 0 : storage.getCurrentTimeStamp() + parseInt(duration)
                            };
                        ...
                        getItem: function (key) {
                            ...
                            var now = storage.getCurrentTimeStamp();
                            var obj;
                            try {
                                obj = JSON.parse(data);
                            } catch (e) {
            ...
            if ($.os.plus) {
                $.plusReady(function () {
                    ...
                    if ($.os.ios && $.options.statusBarBackground) {
                        plus.navigator.setStatusBarBackground('#248cfa')
                    }
